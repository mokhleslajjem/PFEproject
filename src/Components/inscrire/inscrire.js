...
//   });
//   const { nom, prenom, email, langues, competence, avis, telephone, password, password2 } = formData
...
//                   <button className="btn-submit" type="submit" onClick={handleSubmit}>Inscription <Link to="/login"></Link> </button>
//                 </div>
